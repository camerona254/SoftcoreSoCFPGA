...
HD_PWD='C:/Users/cmrnn/Desktop/SoftcoreSoCFPGA/Block Memory/Vivado Project/Block Memory.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sw2hex.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sw2hex.tcl -notrace
