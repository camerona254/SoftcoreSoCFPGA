...
HD_PWD='C:/Users/cmrnn/Desktop/Reaction Timer/Reaction Timer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log period_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source period_counter.tcl -notrace
